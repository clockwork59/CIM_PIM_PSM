...
CIM_CMMS   = Namespace("https://cim.medical/ontology/v4.0/cmms#")
CMMS_INST  = Namespace("https://cim.medical/ontology/v4.0/cmms/instances#")
...
def main():
    ...
    g.add((ont_uri, OWL.imports, URIRef("https://cim.medical/ontology/v4.0/cmms")))
