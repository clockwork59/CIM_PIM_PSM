...
"""
    ...
    def _find_action_chain(self) -> URIRef | None:
        ...
        query = """
PREFIX cim-sec: <https://cim.medical/ontology/v4.0/security_event#>
SELECT ?chain WHERE {
...
"""
        ...
        rows2 = list(self.g.query(
            "SELECT ?c WHERE { ?c rdf:type <https://cim.medical/ontology/v4.0/security_event#ActionChain> } LIMIT 1"
        ))
