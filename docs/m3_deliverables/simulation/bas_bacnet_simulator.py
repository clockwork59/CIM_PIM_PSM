...
ABOX_DDC   = BASE / "cim/abox/nbu_ddc_control_instances.ttl"
...
CIM_EQUIP  = Namespace("http://hospital-cim.org/v4/equipment#")
CIM_BACNET = Namespace("http://hospital-cim.org/v4/bacnet#")
INST       = Namespace("http://hospital-cim.org/v4/instances#")
BACNET     = Namespace("http://hospital-cim.org/v4/bacnet/instances#")
XSD_NS     = XSD
...
def main():
    ...
    bas_g.add((ont_uri, OWL.imports,     URIRef("http://hospital-cim.org/v4/bacnet")))
