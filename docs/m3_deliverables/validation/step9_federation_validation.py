...
DATA_SOURCES = {
    ...
    "DDC":     BASE / "cim/abox/nbu_ddc_control_instances.ttl",
...
PREFIX cim-bacnet: <http://hospital-cim.org/v4/bacnet#>
PREFIX cim-equip: <http://hospital-cim.org/v4/equipment#>
...
PREFIX rdfs:     <http://www.w3.org/2000/01/rdf-schema#>
PREFIX cim:      <http://hospital-cim.org/v4/core#>
PREFIX cim-cmms: <http://hospital-cim.org/v4/cmms#>
...
WHERE {
    ...
    FILTER(?statusNode != <http://hospital-cim.org/v4/cmms#status_Completed>)
    FILTER(?statusNode != <http://hospital-cim.org/v4/cmms#status_Cancelled>)
}
ORDER BY ?equipID
LIMIT 20
""",
...
WHERE {
    ...
    ?wo  cim-cmms:maintenanceTarget   ?equip ;
         cim-cmms:hasWorkOrderID      ?woID ;
         cim-cmms:hasWorkOrderStatus  <http://hospital-cim.org/v4/cmms#status_Open> ;
...
PREFIX rdfs:       <http://www.w3.org/2000/01/rdf-schema#>
PREFIX cim:        <http://hospital-cim.org/v4/core#>
PREFIX cim-d:      <http://hospital-cim.org/v4/design#>
PREFIX cim-bacnet: <http://hospital-cim.org/v4/bacnet#>
...
WHERE {
    ?wo  rdf:type  <http://hospital-cim.org/v4/cmms#PreventiveMaintenance> ;
